...
if __name__ == '__main__':
    train(model_cls=SimpleCNN, num_epochs=25, lr=0.001, kernel_size_1=5, filters_num_1=100, filters_num_2=100)

    eff_net_cls = partial(EfficientNet, 'tf_efficientnet_b0_ns', True)
    train(model_cls=eff_net_cls, num_epochs=10, lr=0.0001, batch_size=24)
